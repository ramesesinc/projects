...
public class RegistrationActivity extends SettingsMenuActivity  
{
	...
	private void doRegister() {
		...
		if (isEmpty(terminalkey)) {
			...
			ApplicationUtil.showShortMsg("Terminal Key is required", RegistrationActivity.this);
			
		} else if (isEmpty(registeredby)) {
			requestFocus(R.id.et_registration_registeredby);
			ApplicationUtil.showShortMsg("Registered By is required", RegistrationActivity.this);
	...
	private Handler errorHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			if (o instanceof Throwable) {
				...
				ApplicationUtil.showShortMsg("[ERROR] " + t.getMessage(), RegistrationActivity.this);
			} else {
				ApplicationUtil.showShortMsg("[ERROR] " + o, RegistrationActivity.this);
			}
		}
	};
	...
	private Handler successHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			Bundle data = msg.getData();			
			ApplicationUtil.showShortMsg(data.getString("response"), RegistrationActivity.this);
