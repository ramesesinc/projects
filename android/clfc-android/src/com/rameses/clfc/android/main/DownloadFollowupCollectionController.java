...
//	private UIActivity activity;
	...
	DownloadFollowupCollectionController(UIActionBarActivity activity, ProgressDialog progressDialog, Map collection) {
...
//				remarksdb.endTransaction();
		...
		private void saveSpecialCollectionImpl(SQLTransaction clfcdb, Map map) throws Exception {
			...
			String billdate = collection.get("billdate").toString();
			String billingid = "";
			synchronized (MainDB.LOCK) {
				...
				if (billingid == null || "".equals(billingid)) {
					...
					mParams.put("name", collectorid + "-" + date);
