...
public class AccountSearchAdapter extends ArrayAdapter<Map> {

	private AccountSearchActivity activity;
...
//            }
	...
	public AccountSearchAdapter(Context context, int resource) {
		super(context, resource);
		this.activity = (AccountSearchActivity) context;
...
//		println("return filter");
	...
	void println(String msg) {
		Log.i("AccountSearchAdapter", msg);
	}
}
