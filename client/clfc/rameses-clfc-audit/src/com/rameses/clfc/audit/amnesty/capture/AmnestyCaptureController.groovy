...
class AmnestyCaptureController
{
    @Binding
    def binding;
    ...
    def getOptionsList() {
        getOpeners: {
            def list = Inv.lookupOpeners("amnestycapture-plugin", [entity: entity, mode: mode]);
    ...
    def closeAmnesty() {
        ...
        return Inv.lookupOpener('remarks:create', [title: 'Reason for Close', handler: handler]);
    }
}
