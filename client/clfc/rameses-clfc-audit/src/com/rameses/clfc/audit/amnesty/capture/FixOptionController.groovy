...
class FixOptionController 
{
    ...
    def recommendationHandler = [
        ...
        onOpenItem: { itm, colName->
            return Inv.lookupOpener('offercapture:open', [entity: itm, mode: mode])
        }
    ] as BasicListModel
    ...
    def tableHandler = [
        ...
        onOpenItem: { itm, colName-> 
            ...
            return Inv.lookupOpener('offercapture:open', [entity: itm, mode: mode, isfla: isfla]);
    ...
    def addRecommendation() {
        ...
        return Inv.lookupOpener('offercapture:create', [handler: handler, parentid: entity.objid, mode: mode]);
    }
