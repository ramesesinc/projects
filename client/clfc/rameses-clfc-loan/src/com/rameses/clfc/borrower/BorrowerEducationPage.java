 ...
 */
@StyleSheet
public class BorrowerEducationPage extends javax.swing.JPanel {
    
    public BorrowerEducationPage() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        xDataTable1.setColumns(new com.rameses.rcp.common.Column[]{
            new com.rameses.rcp.common.Column(new Object[]{
                ...
                , new Object[]{"caption", "School Attended"}
        ...
        xDataTable1.setHandler("educationHandler");
        xDataTable1.setName("selectedEducation");
        ...
        xButton2.setDepends(new String[] {"selectedEducation"});
        xButton2.setDisableWhen("#{selectedEducation == null || borrowerContext.mode=='read'}");
        xButton2.setName("removeEducation");
        xButton2.setText("Remove");

        xButton1.setName("addEducation");
        ...
        xHtmlView1.setDepends(new String[] {"selectedEducation"});
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(xSplitView1, javax.swing.GroupLayout.DEFAULT_SIZE, 473, Short.MAX_VALUE)
        );
