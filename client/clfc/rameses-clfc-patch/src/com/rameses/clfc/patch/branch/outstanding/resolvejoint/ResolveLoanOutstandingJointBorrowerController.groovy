...
class ResolveLoanOutstandingJointBorrowerController 
{
    @Binding
    def binding;
    
    @Service('ResolveLoanOutstandingJointBorrowerService')
    def service;
    ...
    String title = 'Resolve Loan Outstanding Joint Borrower(s)';
