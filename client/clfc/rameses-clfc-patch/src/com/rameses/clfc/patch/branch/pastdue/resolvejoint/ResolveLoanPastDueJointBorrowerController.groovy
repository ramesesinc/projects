package com.rameses.clfc.patch.branch.pastdue.resolvejoint
...
class ResolveLoanPastDueJointBorrowerController 
{
    @Binding
    def binding;
    
    @Service('ResolveLoanPastDueJointBorrowerService')
    def service;
    ...
    String title = 'Resolve Loan Past Due Joint Borrower(s)';
