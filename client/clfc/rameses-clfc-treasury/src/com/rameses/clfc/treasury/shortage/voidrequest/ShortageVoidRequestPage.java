...
public class ShortageVoidRequestPage extends javax.swing.JPanel {

    /**
     * Creates new form ShortageVoidRequestPage
     */
    public ShortageVoidRequestPage() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        xTitledBorder1.setTitle("Shortage Information");
        ...
        xLookupField1.setExpression("#{entity.shortage.refno}");
        xLookupField1.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        xLookupField1.setHandler("shortageLookupHandler");
        ...
        xDateField1.setName("entity.shortage.txndate"); // NOI18N
        xDateField1.setOutputFormat("MMM-dd-yyyy");
        xFormPanel1.add(xDateField1);

        xLabel2.setCaption("CBS No.");
        xLabel2.setExpression("#{entity.shortage.cbsno}");
        ...
        xDecimalField1.setName("entity.shortage.amount"); // NOI18N
        xFormPanel1.add(xDecimalField1);

        xLabel3.setCaption("Collector");
        xLabel3.setExpression("#{entity.shortage.collector.name}");
        ...
        xPanel1Layout.setVerticalGroup(
            ...
            .addGroup(xPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(xFormPanel1, javax.swing.GroupLayout.DEFAULT_SIZE, 134, Short.MAX_VALUE)
                .addContainerGap())
        );
