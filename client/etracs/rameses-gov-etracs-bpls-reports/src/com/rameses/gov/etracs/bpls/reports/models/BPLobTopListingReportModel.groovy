...
public class BPLobTopListingReportModel extends AsyncReportController {
    ...
    def formControl = [ 
        getControlList: { 
            return [
                ...
                [type:'combo', caption:'Classification', name:'entity.classification', preferredSize:'0,20', captionWidth:130, items:'classificationlist', expression:'#{item.name}'], 
