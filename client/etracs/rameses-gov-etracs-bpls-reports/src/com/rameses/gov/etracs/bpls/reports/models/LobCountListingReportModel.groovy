...
public class LobCountListingReportModel extends AsyncReportController {
    ...
    def formControl = [
        getControlList: { 
            return [
                ...
                [type:'checklist', caption:'Status', name:'entity.appstates', immediate:true, preferredSize:'0,55', items:'appStatusList', itemExpression:'#{item.title}', selectionMode:'MULTIPLE', itemCount:3, captionWidth:100 ],
