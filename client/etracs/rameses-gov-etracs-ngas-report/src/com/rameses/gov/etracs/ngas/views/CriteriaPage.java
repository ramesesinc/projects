 ...
 */
package com.rameses.gov.etracs.ngas.views;
...
public class CriteriaPage extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        xComboBox8.setCaption("Acct Type");
        xComboBox8.setExpression("  #{item.title}");
        xComboBox8.setItems("accttypes");
        xComboBox8.setName("entity.accttype"); // NOI18N
        xComboBox8.setCaptionWidth(120);
        xComboBox8.setImmediate(true);
        xComboBox8.setPreferredSize(new java.awt.Dimension(300, 20));
        xFormPanel1.add(xComboBox8);

        xComboBox6.setCaption("Fund");
        xComboBox6.setExpression("  #{item.desc}");
