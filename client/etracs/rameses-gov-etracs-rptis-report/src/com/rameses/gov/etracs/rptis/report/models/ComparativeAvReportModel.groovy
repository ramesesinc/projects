...
class ComparativeAvReportModel extends AsyncReportModel2
{
    @Service('RPTReportComparativeAVService') 
    def svc 
    
    String title = 'Comparative Data on Assessed Value'
    
    String reportName = 'com/rameses/gov/etracs/rptis/reports/comparativeav.jasper';
    
        
    void buildReportData(entity, asyncHandler){
        svc.generateComparativeAV(entity, asyncHandler)
    }
