...
@StyleSheet
public class AFTxnControlEntryPage extends javax.swing.JPanel {

    /**
     * Creates new form AFReceiptItemDetailPage
     */
    public AFTxnControlEntryPage() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        xLabel5.setExpression("#{ afunit.formtype }");
        ...
        xNumberField1.setName("stubno"); // NOI18N
        xNumberField1.setDepends(new String[] {"entry.qty"});
        ...
        xTextField5.setName("entry.currentseries"); // NOI18N
        ...
        xTextField5.setVisibleWhen("#{ entry.qty == 1 }");
        ...
        xTextField6.setCaption("Remaining Qty");
        xTextField6.setName("qtybalance"); // NOI18N
        xTextField6.setDepends(new String[] {"entry.qty"});
        xTextField6.setEnabled(false);
        xTextField6.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        xTextField6.setPreferredSize(new java.awt.Dimension(150, 20));
        xTextField6.setVisibleWhen("#{ entry.qty == 1 }");
