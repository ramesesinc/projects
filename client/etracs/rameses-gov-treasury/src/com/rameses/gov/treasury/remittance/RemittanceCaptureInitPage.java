...
public class RemittanceCaptureInitPage extends javax.swing.JPanel {
    
    /** Creates new form RemittanceInitPage */
    public RemittanceCaptureInitPage() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        xNumberField1.setDepends(new String[] {"entity.dtposted", "entity.collector"});
        ...
        formPanel2.setBounds(350, 420, 224, 44);
        ...
        xLookupField2.setCaption("Liquidating Officer");
        xLookupField2.setCaptionWidth(120);
        xLookupField2.setExpression("#{item.name}");
        xLookupField2.setHandler("liquidatingofficer:lookup");
        xLookupField2.setName("entity.liquidatingofficer"); // NOI18N
        ...
        xButton1.setBounds(40, 430, 75, 23);
        ...
        xButton2.setBounds(120, 430, 90, 23);
