...
public class MatchNameListPage extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        xButton1.setName("selectMatchedPatient");
        xButton1.setText("Select this patient");

        xLabel6.setExpression("The system has found potential matches for <b>#{entity.lastname}, #{entity.firstname}</b>. If the patient is not on this list, proceed by clicking 'Add as new Patient' ");
