 ...
 * @author dell
 */
@ComponentBean("com.rameses.enterprise.components.CivilStatusListModel")
public class CivilStatusList extends XComponentPanel {

    /**
     * Creates new form CivilStatusList
     */
    ...
    private void initComponents() {
        ...
        component.setCaption("Civil Status");
        component.setExpression("#{item.value}");
        component.setItemKey("key");
        component.setItems("civilStatusList");
        component.setName("civilStatus"); // NOI18N
