...
select 
	...
	b.orgtype, b.businessname, b.tradename, b.address_text as businessaddress, addr.barangay_name, 
	b.owner_name, b.owner_address_text as owner_address, tmp2.assessmenttype, 
...
from ( 
	select 
		applicationid, lobid, assessmenttype, 
	...
	from ( 
		select 
			ba.objid as applicationid, bal.lobid, bal.assessmenttype,  
