...
SELECT 
	...
	b.name AS barangay,
	b.indexno, 
	SUM( CASE WHEN rp.claimno is null and r.taxable = 1 THEN 1.0 ELSE 0.0 END ) AS landtaxablecount,
	SUM( CASE WHEN rp.claimno is null and r.taxable = 0 THEN 1.0 ELSE 0.0 END ) AS landexemptcount,
