...
SELECT wa.objid, $P{batchid}, 'PENDING', $P{duemonth}, 
$P{dueyear}, $P{duedate}, $P{fromdate}, $P{todate}, $P{discodate}, 
$P{rundate},$P{items}
...
INNER JOIN waterworks_area wrg on wrg.objid = ws.areaid
...
wa.phoneno, wa.email, wm.serialno, wa.classificationid, wa.lastreadingyear, 
wa.lastreadingmonth, wa.lastreadingdate, wa.lastreading, wa.prevreading,wa.balance,
wd.year, wd.month, wd.duedate,wd.fromdate, wd.todate, wd.discodate, wd.rundate, 
wa.address_barangay_objid AS barangay, wm.sizeid AS metersize
FROM waterworks_account wa
