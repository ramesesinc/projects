...
(function (factory) {
  ...
  var buttonGroup = renderer.create('<div class=" -group btn-group">');
  ...
  var ImageDialog = function (context) {
    ...
    this.initialize = function () {
      ...
      var body = '<div class="form-group note-group-select-from-files btn btn-primary ">' +
  ...
  var VideoDialog = function (context) {
    ...
    this.initialize = function () {
      ...
      var body = '<div class="form-group row-fluid">' +
          ...
          '<input class="note-video-url form-control col-md-12" type="text" />' +
          '</div>';
    ...
    this.createVideoNode = function (url) {
      ...
      if (ytMatch && ytMatch[1].length === 11) {
        ...
        $video = $('<iframe>')
            ...
            .attr('width', '340').attr('height', '160');
      ...
      $video.addClass('note-video-clip fr-element');
