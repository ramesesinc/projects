(function (factory) {
	...
	var floatBSPlugin = function (context) {
		...
		context.memo('button.floatBSLeft', function () {
			return ui.button({
				contents: '<span class="fa fa-align-left"></span>',
		...
		context.memo('button.floatBSRight', function () {
			return ui.button({
				contents: '<span class="fa fa-align-right"></span>',
		...
		context.memo('button.floatBSNone', function () {
			return ui.button({
				contents: '<span class="fa fa-align-justify"></span>',
				tooltip: lang.floatBS.floatNone,
				click: function(event) {
					var $img=$(editable.data('target'));
					$img.removeClass('pull-right pull-left').addClass('none');
					context.invoke('editor.afterCommand');
				}
			}).render();
		});
