...
public class AnnotationApproveTest  {
    ...
    public static void setUpClass() {
        ...
        annotation = annotationModel.approve(annotation);
        
        remoteAnnotation = Data.findRemoteEntity("faasannotation", annotation, true);
    }
    ...
    @Test
    public void shouldChangeStateToApproved() {
        assertEquals("APPROVED", annotation.get("state"));
    }
    
    /*----------------------------------------------------------
     * REMOTE ANNOTATION TEST  
     ----------------------------------------------------------*/
    @Test
    public void shouldCreateRemoteAnnotation() {
        assertNotNull(remoteAnnotation);
    }
    
    @Test
    public void remoteStateShouldBeApproved() {
        assertEquals("APPROVED", remoteAnnotation.get("state"));
    }
}
