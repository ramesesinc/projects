...
public class CaptureLobPage extends javax.swing.JPanel {
    
    /** Creates new form BusinessGeneralInfo */
    public CaptureLobPage() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        xDataTable1.setColumns(new com.rameses.rcp.common.Column[]{
            new com.rameses.rcp.common.Column(new Object[]{
                new Object[]{"name", "oldname"}
                , new Object[]{"caption", "Previous Line of Business"}
        ...
        xDataTable1.setPreferredSize(new java.awt.Dimension(720, 80));
